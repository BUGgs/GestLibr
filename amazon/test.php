...
class BookSearcher {
        ...
        public function getBookByISBN($isbn) {
                ...
                if ($this->xpp->open('http://books.google.com/books/feeds/volumes?q=editions:ISBN' . urlencode($isbn) . '&lr=fr')) {
                        $this->moveToEntry();
...
$recherche = new BookSearcher;

echo 'Résultats:<pre>';
print_r($recherche->getBookByISBN($_GET[isbn]));
echo '</pre>';
