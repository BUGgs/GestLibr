...
// Version 1.01
// NB:
// les fonctions dont la 1ère lettre est majuscule se réfèrent
//    à la classe FPDF
// les fonctions dont la 1ère lettre est minuscule se réfèrent
//    à la classe locale (i.e. invoice)
//
// RAF (Reste A Faire):
...
{
	$this->SetFont( "Helvetica", "", 10);
	$length = $this->GetStringWidth( "Référence Commande : " . $ref );
	$r1  = 10;
	$r2  = $r1 + $length;
	$y1  = 92;
	$y2  = $y1+5;
	$this->SetXY( $r1 , $y1 );
	$this->Cell($length,4, "Référence Commande : " . $ref);
}
